...
function Check() {
  ...
  var levelszameredmeny =
    "n" + "log" + "<sub>" + N_elem + "</sub>" + " " + T_elem;
...
function RekurziosGyak() {
  return (
    <form>
      <h1 className="normalpad">Rekurzios fa feladat generátor</h1>
      ...
      <div class="form-group">
        ...
        <div className="hidden" id="showquests">
          <div class="container ">
            ...
            <div class="row justify-content-center text-center">
              ...
              <div class="col-2">
                <div className="normalpad">
                  ...
                  <input type="text" class="form-control" id="quest1-1-csucs" />
                </div>
              </div>
              <div class="col-4">
                <div className="normalpad">
