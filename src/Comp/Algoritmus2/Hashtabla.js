...
export default function Hashtabla() {
  return (
    <form>
      <h1 className="highpad">Hash tábla</h1>
      <div class="form-group">
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-2">
              <b>Hash tábla hossza :</b>
          ...
          <div class="row justify-content-center text-center">
            <Button variant="success" onClick={Begin}>
              Megad
            </Button>
          </div>
        </div>
      ...
      <div className="normalpad">
        <div className="hidden" id="c1c2">
          <b>c1 : </b>
          <input type="text" id="c1" class="col-2"></input>
          <b>c2 : </b>
          <input type="text" id="c2" class="col-2"></input>
          <br />
        </div>

        <div className="highpad" id="generate"></div>
        <div class="row justify-content-center text-center">
          <Button variant="success" onClick={Solve}>
            Megold
          </Button>
        </div>
