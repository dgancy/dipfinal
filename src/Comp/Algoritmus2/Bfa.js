  ...
  for (let i = 0; i < SplittedArray.length; i++) {
    ...
    if (state == 1) {
      if (
        ...
        SplittedArray[i] < OutputArrayRight_1[OutputArrayRight_1.length - 1] &&
        SplittedArray[i] > OutputArrayEdge[OutputArrayEdge.length - 1]
      ) {
  ...
  return (
    <form>
            ...
            <div class="row justify-content-center text-center">
              ...
              <div class="col-2">
                ...
                <input
                  ...
                  id="elements"
                />
                <small class="form-text text-muted">(Input elemek)</small>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div className="normalpad">
          <div class="row justify-content-center">
            <div class="col-2 border border-success"><b id="arrayleft_2"></b></div>
            <div class="col-2 border border-success"><b id="arraymiddle_1"></b></div>
            <div class="col-2 border border-success"><b id="arraymiddle_2"></b></div>
            <div class="col-2 border border-success"><b id="arrayright_2"></b></div>
          </div>
        </div>        
      </div>      
    </form>
